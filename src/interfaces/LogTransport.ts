/**
 * This type represents the different transports that can be used by the logger
 * that determine where logging data should be sent.
 *
 ...
 */
export type LogTransport = 'file' | 'console' | 'mezmo' | 'all'
